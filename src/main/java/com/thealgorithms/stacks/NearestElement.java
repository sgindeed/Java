...
/**
 * NearestElement implements four classic stack-based algorithms:
 * - Nearest Greater to Right
 * - Nearest Greater to Left
 * - Nearest Smaller to Right
 * - Nearest Smaller to Left
 *
 * Each method takes an integer array as input and returns an array of integers
 * representing the nearest element according to the rule.
 */
